...
import no.nordicsemi.android.nrfmesh.ble.BleMeshManager_Factory;
...
import static no.nordicsemi.android.nrfmesh.R.layout.list_text;
...
public class ListViewAdapter extends RecyclerView.Adapter<ListViewAdapter.MyHolder>{
    ...
    public ListViewAdapter(Context context, List<TextString> modelList){
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(list_text, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int i) {
        ...
        holder.addBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Ref3.child(String.valueOf(roomnumber)).setValue(new TextGroup(roomnumber));
                Toast.makeText(context,""+roomnumber+" already in group", Toast.LENGTH_SHORT).show();
            }
        });
    }
