...
public class GenericOnOffSetUnacknowledged extends GenericMessage {
    ...
    private static final int GENERIC_ON_OFF_SET_TRANSITION_PARAMS_LENGTH = 22;//4
    private static final int GENERIC_ON_OFF_SET_PARAMS_LENGTH = 22;  //2
    ...
    public GenericOnOffSetUnacknowledged(@NonNull final ApplicationKey appKey,
                                         final boolean state,
                                         final int tId , final int mes) throws IllegalArgumentException {
        this(appKey, state, tId, mes,null, null, null);
    }
    ...
    void assembleMessageParameters() {
        ...
        if (mTransitionSteps == null || mTransitionResolution == null || mDelay == null) {
            ...
            paramsBuffer.put((byte) this.mes);
        } else {
